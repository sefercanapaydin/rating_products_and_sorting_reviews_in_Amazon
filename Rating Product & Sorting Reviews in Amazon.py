...
df.info()
df.head()
average_rating = df["overall"].sum()/len(df)
...
t_based_weighted_average = time_based_weighted_average(df)


#since t_based_weighted_average is higher than normal average we can say that the product seller increasing its performance somehow
###################################################
